    ...
    children: [
      {
        ...
        name: 'Dashboard',
        meta: { title: 'Painel', icon: 'dashboard', noCache: false },
      },
    ],
  },
    ...
    children: [
      {
        ...
        name: 'Pagamentos',
        meta: { title: 'Pagamentos', icon: 'user', noCache: false },
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        component: () => import('@/views/dashboard/index'),
        name: 'funcionarios',
        meta: { title: 'Funcionários', icon: 'user', noCache: false },
      },
    ],
  },
  {
    ...
    children: [
      {
        ...
        component: () => import('@/views/dashboard/index'),
        name: 'fornecedores',
        meta: { title: 'Fornecedores', icon: 'shopping', noCache: false },
      },
    ],
  },
  {
    ...
    component: Layout,
    redirect: 'pagamentos',
    meta: { title: 'Pagamentos', icon: 'money' },
    children: [
      {
        path: 'pagamentos',
        component: () => import('@/views/dashboard/index'),
        name: 'Cadastrar',
        meta: { title: 'Cadastrar', icon: 'el-icon-circle-plus', noCache: false },
      },
      {
        path: 'relatorio',
        component: () => import('@/views/zip'),
        name: 'relatorio',
        meta: { title: 'Relatório', icon: 'example', noCache: false },
      },
    ],
  },
  {
